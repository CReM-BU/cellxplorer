...
### Tab1.e1: Cell selection 
  ...
  tabPanel(
   ...
   ,    
br(), 
#p("Center for Regenerative Medicine", style = "font-size: 125%;"), 
p("Experiment Details", style="font-size: 100%"),
p("scRNA-seq comparing: iAT2s before differentiation to iAT1s (CK+DCI) as well as iAT1s at 24, 48, and 72 hours post media change to L+DCI for differentiation into iAT1s. (BU3 NGAT human iPSC line). Cells were grown in 3D culture indicated number of days before dissociation and sorting for viability. Single cells were captured for sequencing library preparation using a 10x chromium instrument at different days and samples were combined for sequencing.", style="font-size: 80%"),
p("Manuscript figures (Figure 6 and Supplemental Figure 6) were made at using “new_cluster”.", style="font-size: 80%"),
p(a("Center for Regenerative Medicine of Boston University and Boston Medical Center", 
